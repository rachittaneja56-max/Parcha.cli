            ...
            >
              <FieldGroup className="gap-5">
                <Field data-invalid={!!form.formState.errors.fullName}>
                  <FieldLabel htmlFor="reg-fullname" className="text-zinc-300 text-sm font-medium">
                    Full name
                  </FieldLabel>
                  <Input
                    id="reg-fullname"
                ...
                <Field data-invalid={!!form.formState.errors.email}>
                  <FieldLabel htmlFor="reg-email" className="text-zinc-300 text-sm font-medium">
                    Email
                  </FieldLabel>
                  <Input
                    id="reg-email"
                ...
                <Field data-invalid={!!form.formState.errors.password}>
                  <FieldLabel htmlFor="reg-password" className="text-zinc-300 text-sm font-medium">
                    Password
                  </FieldLabel>
                  <Input
                    id="reg-password"
                  ...
                  />
                  <FieldDescription className="text-xs text-zinc-600 font-mono mt-1">
